...
class BookingTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create booking_type" do
    assert_difference("BookingType.count") do
      post booking_types_url, params: { booking_type: { description: @booking_type.description, duration: @booking_type.duration, location: @booking_type.location, name: @booking_type.name, payment_required: @booking_type.payment_required, price: @booking_type.price, user_id: @booking_type.user_id } }
    end
  ...
  test "should update booking_type" do
    patch booking_type_url(@booking_type), params: { booking_type: { description: @booking_type.description, duration: @booking_type.duration, location: @booking_type.location, name: @booking_type.name, payment_required: @booking_type.payment_required, price: @booking_type.price, user_id: @booking_type.user_id } }
